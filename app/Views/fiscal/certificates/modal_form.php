...
<div class="modal-body">
    ...
    <div class="form-group row"><label class="col-md-4"><?php echo app_lang('private_key_password'); ?></label><div class="col-md-8"><input type="password" name="private_key_password" autocomplete="new-password" class="form-control" required><small><?php echo app_lang('csd_password_not_stored'); ?></small></div></div>
