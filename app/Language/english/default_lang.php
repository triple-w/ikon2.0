...
$lang["fiscal_items_view"] = "View fiscal product configuration";
$lang["fiscal_items_manage"] = "Manage fiscal product configuration";
$lang["fiscal_item_configuration"] = "Fiscal configuration";
$lang["item_fiscal_optional_help"] = "SAT configuration is optional for estimates and sales, but will be required for a future CFDI.";
$lang["fiscal_item_read_only"] = "You have read-only access to this SAT configuration.";
$lang["item_type"] = "Type";
$lang["sat_product_service_key"] = "Product/service SAT key";
$lang["sat_unit_key"] = "SAT unit key";
$lang["commercial_unit"] = "Commercial unit";
$lang["commercial_vs_sat_unit_help"] = "The commercial unit describes how the item is sold. The SAT unit key belongs to the SAT catalog.";
$lang["tax_object_code"] = "Tax object";
$lang["fiscal_description"] = "Fiscal description";
$lang["fiscal_description_fallback_help"] = "When empty, the administrative description will be used during fiscal preparation.";
$lang["identification_number"] = "Identification number";
$lang["item_fiscal_status_not_configured"] = "No fiscal configuration";
$lang["item_fiscal_status_incomplete"] = "Incomplete for invoicing";
$lang["item_fiscal_status_ready"] = "Complete for invoicing";
$lang["item_fiscal_status_inactive"] = "Inactive configuration";
$lang["fiscal_review"] = "Fiscal review";
$lang["fiscal_review_status_not_ready"] = "Not ready";
$lang["fiscal_review_status_ready_with_warnings"] = "Ready with warnings";
$lang["fiscal_review_status_ready"] = "Ready for fiscal preparation";
$lang["fiscal_review_no_stamp_help"] = "This review does not generate a CFDI, XML, or stamping and is not the definitive fiscal calculation.";
$lang["fiscal_address"] = "Fiscal address";
$lang["copy_commercial_address"] = "Copy commercial address";
$lang["fiscal_address_cfdi_help"] = "The fiscal postal code is the receiver address value used directly by CFDI 4.0. The other fields are retained for the administrative record and representation.";
$lang["fiscal_municipality"] = "Municipality or borough";
$lang["fiscal_locality"] = "Locality";
$lang["fiscal_neighborhood"] = "Neighborhood";
$lang["street"] = "Street";
$lang["external_number"] = "External number";
$lang["internal_number"] = "Internal number";
$lang["references"] = "References";
$lang["fiscal_item_not_found"] = "The requested product or service does not exist.";
$lang["fiscal_item_form_error"] = "The fiscal configuration could not be loaded. Diagnostic details were logged.";
$lang["fiscal_country_code_invalid"] = "The fiscal country must use a three-letter code, for example MEX.";
$lang["fiscal_applicable_taxes"] = "Applicable fiscal taxes";
$lang["automatic_summary"] = "Automatic summary";
$lang["used_description"] = "Description used";
$lang["fiscal_advanced_tax_object_warning"] = "This configuration retains an advanced 03 or 04 tax object. It will not be changed automatically.";
$lang["activate_fiscal_configuration"] = "Activate fiscal configuration";
$lang["deactivate_fiscal_configuration"] = "Deactivate fiscal configuration";
$lang["tax_object_01_short"] = "Not subject to tax";
$lang["tax_object_02_short"] = "Subject to tax";
$lang["fiscal_item_type_required"] = "Select whether this is a product or service.";
$lang["fiscal_duplicate_taxes"] = "The same tax cannot be selected more than once.";
$lang["fiscal_catalog_key_inactive"] = "The selected SAT key does not exist or is inactive.";
$lang["fiscal_tax_not_ready"] = "One or more selected taxes are not fiscally ready.";
$lang["administrative_total"] = "Administrative total";
...
$lang["estimate_accepted_and_converted"] = "Estimate accepted and converted to sale";
$lang["estimate_already_accepted_and_processed"] = "This estimate has already been accepted and processed";
$lang["estimate_status_cannot_be_changed"] = "This estimate no longer allows that action";
$lang["estimate_cancelled"] = "Estimate cancelled";
$lang["cost"] = "Cost";
$lang["profit_over_cost_percentage"] = "Profit over cost (%)";
$lang["sale_price"] = "Sale price";
$lang["proposal_accepted_and_converted"] = "Proposal accepted and converted to sale";
$lang["proposal_accept_and_convert"] = "Accept proposal and convert to sale";
...
$lang["expedition_postal_code"] = "Place-of-issue postal code";
$lang["issuer_status_not_configured"] = "Not configured";
$lang["issuer_status_incomplete"] = "Incomplete configuration";
$lang["issuer_status_ready"] = "Ready to issue";
$lang["issuer_status_inactive"] = "Inactive";
$lang["fiscal_series"] = "Fiscal series";
$lang["fiscal_series_single"] = "Fiscal series";
$lang["add_fiscal_series"] = "Add fiscal series";
$lang["fiscal_series_help"] = "Fiscal series are separate from administrative numbering. Preview does not consume a folio.";
$lang["document_type"] = "Document type";
$lang["fiscal_document_type_ingreso"] = "Income";
$lang["fiscal_document_type_egreso"] = "Expense";
$lang["fiscal_document_type_pago"] = "Payment";
$lang["initial_folio"] = "Initial folio";
$lang["next_folio"] = "Next folio";
$lang["without_series"] = "Without series";
$lang["fiscal_series_duplicate"] = "That issuer, document type and series combination already exists.";
$lang["fiscal_issuers_view"] = "View fiscal issuers";
$lang["fiscal_issuers_manage"] = "Manage fiscal issuers";
$lang["fiscal_series_view"] = "View fiscal series";
$lang["fiscal_series_manage"] = "Manage fiscal series";
$lang["fiscal_sales_review"] = "Review fiscal preparation of sales";
$lang["receiver_fiscal_profile"] = "Receiver fiscal profile";
$lang["fiscal_review_status_not_ready"] = "Not ready";
$lang["fiscal_review_status_ready_with_warnings"] = "Ready with warnings";
$lang["fiscal_review_status_ready_for_fiscal_preparation"] = "Ready for fiscal preparation";
$lang["fiscal_review_preparation_help"] = "This review does not create a CFDI, stamp, or consume folios.";
$lang["preview_does_not_consume_folio"] = "This preview does not consume the folio.";
$lang["refresh_review"] = "Refresh review";
$lang["sale"] = "Sale";
...
$lang["tax_pricing_policy"] = "Price and tax policy";
$lang["tax_pricing_policy_help"] = "Defines how administrative prices are interpreted during fiscal preparation.";
$lang["tax_pricing_mode_tax_inclusive"] = "Prices include taxes";
$lang["tax_pricing_mode_tax_inclusive_help"] = "The current total is preserved while its base and included taxes are separated.";
$lang["tax_pricing_mode_tax_exclusive"] = "Taxes are added when invoicing is requested";
$lang["tax_pricing_mode_tax_exclusive_help"] = "Prices are treated as pre-tax and the total and balance may increase.";
$lang["tax_pricing_mode_preserve_total"] = "Preserve total and itemize taxes";
$lang["tax_pricing_mode_preserve_total_help"] = "Tax is extracted from the amount already charged and does not increase the total.";
$lang["allow_sale_tax_pricing_override"] = "Allow changing this policy during fiscal review";
$lang["fiscal_sales_pricing_review"] = "Review fiscal price calculation";
$lang["fiscal_sales_pricing_apply"] = "Apply taxes and adjust sale";
$lang["fiscal_sales_pricing_override"] = "Change a sale pricing policy";
$lang["tax_pricing_override"] = "Policy override for this preparation";
$lang["tax_pricing_override_warning"] = "This affects only the preparation and does not change the issuer policy.";
$lang["use_issuer_policy"] = "Use issuer policy";
$lang["price_treatment"] = "Price treatment";
$lang["administrative_fiscal_comparison"] = "Administrative and fiscal comparison";
$lang["concept"] = "Concept";
$lang["current_sale"] = "Current sale";
$lang["fiscal_preparation"] = "Fiscal preparation";
$lang["economic_difference"] = "Economic difference";
$lang["sale_tax_adjustment_warning"] = "This preparation will add taxes to the sale and change its balance.";
$lang["confirm_sale_tax_adjustment"] = "I confirm that the sale total and balance will be updated.";
$lang["apply_taxes_to_sale"] = "Apply taxes to sale";
$lang["fiscal_sale_adjustment_applied"] = "Sale taxes and balance were updated successfully.";
$lang["advanced_options"] = "Advanced options";
$lang["fiscal_pricing_status_simulated"] = "Simulated";
$lang["fiscal_pricing_status_confirmation_required"] = "Adjustment required";
$lang["fiscal_pricing_status_confirmed"] = "Confirmed";
$lang["fiscal_pricing_status_applied"] = "Adjustment applied";
$lang["fiscal_pricing_status_superseded"] = "Superseded";
$lang["fiscal_pricing_status_cancelled"] = "Cancelled";

$lang["fiscal_drafts_view"] = "View fiscal drafts";
$lang["fiscal_drafts"] = "Drafts";
$lang["fiscal_drafts_create"] = "Create fiscal drafts";
$lang["fiscal_drafts_lock"] = "Lock fiscal preparations";
$lang["fiscal_drafts_supersede"] = "Replace fiscal drafts";
$lang["fiscal_drafts_cancel"] = "Cancel internal preparations";
$lang["create_fiscal_draft"] = "Create fiscal draft";
$lang["fiscal_draft_created"] = "Fiscal draft created successfully.";
$lang["fiscal_draft_already_exists"] = "An identical fiscal draft already exists.";
$lang["fiscal_draft_not_found"] = "The fiscal draft does not exist.";
$lang["fiscal_draft_action_completed"] = "The fiscal preparation was updated.";
$lang["fiscal_preparations"] = "Fiscal preparations";
$lang["fiscal_preparation"] = "Fiscal preparation";
$lang["sat_payment_form"] = "SAT payment form";
$lang["sat_payment_method"] = "SAT payment method";
$lang["exchange_rate"] = "Exchange rate";
$lang["exchange_rate_help"] = "Required for currencies other than MXN. It is not retrieved automatically.";
$lang["confirm_replace_fiscal_draft"] = "I confirm replacement of a previous preparation when source data changed.";
$lang["fiscal_draft_internal_notice"] = "This document is an internal fiscal preparation. It is not yet a CFDI and has no fiscal validity.";
$lang["fiscal_draft_status_draft"] = "Draft";
$lang["fiscal_draft_status_ready"] = "Ready";
$lang["fiscal_draft_status_locked"] = "Locked";
$lang["fiscal_draft_status_superseded"] = "Superseded";
$lang["fiscal_draft_status_cancelled_internal"] = "Internally cancelled";
$lang["fiscal_draft_status_stamped"] = "Stamped (reserved)";
$lang["fiscal_draft_status_stamping_error"] = "Stamping error (reserved)";
$lang["lock_fiscal_preparation"] = "Lock fiscal preparation";
$lang["cancel_internal_preparation"] = "Cancel internal preparation";
$lang["transferred_taxes"] = "Transferred taxes";
$lang["withheld_taxes"] = "Withheld taxes";
$lang["fiscal_draft_source_changed"] = "The administrative sale or its payments changed after this fiscal preparation was created.";
$lang["fiscal_xml_preview_generate"] = "Generate CFDI Pre-XML";
$lang["fiscal_xml_preview_view"] = "View CFDI Pre-XML";
$lang["fiscal_xml_preview_download"] = "Download CFDI Pre-XML";
$lang["fiscal_xml_preview_validate"] = "Validate CFDI Pre-XML";
$lang["prexml_cfdi40"] = "CFDI 4.0 Pre-XML";
$lang["generate_prexml"] = "Generate Pre-XML";
$lang["view_prexml"] = "View Pre-XML";
$lang["download_prexml"] = "Download Pre-XML";
$lang["validate_prexml"] = "Validate again";
$lang["prexml_generated"] = "Pre-XML generated successfully.";
$lang["prexml_already_exists"] = "The identical Pre-XML already exists.";
$lang["prexml_validated"] = "Local validation was updated.";
$lang["prexml_not_found"] = "The Pre-XML artifact does not exist.";
$lang["prexml_no_fiscal_validity"] = "This XML is neither sealed nor stamped and has no fiscal validity.";
$lang["semantic_validation"] = "Semantic validation";
$lang["semantic_validation_correct"] = "Semantic validation is correct.";
$lang["semantic_validation_errors"] = "Semantic validation contains errors.";
$lang["structural_validation"] = "Structural validation";
$lang["prexml_status_not_generated"] = "Not generated";
$lang["prexml_status_generated"] = "Pre-XML generated";
$lang["prexml_status_semantic_error"] = "Semantic error";
$lang["prexml_status_schema_pending_signature"] = "Full validation pending certificate and seal";
$lang["prexml_status_invalid"] = "Invalid technical XML";
$lang["prexml_status_valid"] = "Full XSD structure valid";
$lang["prexml_status_superseded"] = "Superseded artifact";
$lang["view_fiscal_draft"] = "View fiscal draft";
$lang["close_fiscal_preparation"] = "Close fiscal preparation";
$lang["series"] = "Series";
$lang["folio"] = "Folio";
$lang["fiscal_document_type_income"] = "Income";
$lang["product_service_key"] = "Product/service key";
$lang["unit_key"] = "Unit key";
$lang["unit_value"] = "Unit value";
$lang["tax_summary"] = "Tax summary";
$lang["back_to_fiscal_review"] = "Back to fiscal review";
$lang["document"] = "Document";
$lang["cfdi_use"] = "CFDI use";
$lang["receiver"] = "Receiver";
$lang["code"] = "Code";
$lang["totals"] = "Totals";
$lang["service"] = "Service";
$lang["not_available"] = "Not available";
$lang["payment_sat_suggestion_help"] = "The suggestion uses the current balance. Review it before creating the fiscal preparation.";
$lang["sat_payment_form_mapping"] = "Mapped SAT payment form";
$lang["sat_payment_form_mapping_help"] = "Explicit mapping for fiscal suggestions. Historical payments are not changed.";
$lang["digital_seal_certificates"] = "Digital seal certificates";
$lang["digital_seal_certificate"] = "Digital seal certificate";
$lang["upload_csd"] = "Upload CSD";
$lang["certificate_file"] = "Certificate file";
$lang["private_key_file"] = "Private key file";
$lang["private_key_password"] = "Private key password";
$lang["csd_password_not_stored"] = "The password is used only during this operation and is not stored.";
$lang["csd_password_strategy_notice"] = "For security, iKontrol requests the key password for every signature.";
$lang["csd_local_validity_notice"] = "Validity was checked locally. SAT status will be verified in a later phase.";
$lang["csd_upload_help"] = "Upload the protected .cer and .key from the same CSD. Files are validated and stored outside the public directory.";
$lang["csd_files_required"] = "Select a valid certificate and private key.";
$lang["csd_uploaded"] = "The CSD was validated and stored successfully.";
$lang["certificate_number"] = "Certificate number";
$lang["valid_from"] = "Valid from";
$lang["valid_to"] = "Valid until";
$lang["csd_status_pending_validation"] = "Not yet valid";
$lang["csd_status_valid"] = "Valid";
$lang["csd_status_expired"] = "Expired";
$lang["csd_status_invalid"] = "Invalid";
$lang["csd_status_mismatched"] = "Mismatched";
$lang["csd_status_inactive"] = "Inactive";
$lang["csd_status_revoked_internal"] = "Internally revoked";
$lang["fiscal_certificates_view"] = "View digital seal certificates";
$lang["fiscal_certificates_manage"] = "Manage digital seal certificates";
$lang["fiscal_xml_sign"] = "Sign XML locally";
$lang["fiscal_signed_xml_view"] = "View locally signed XML";
$lang["local_xml_sealing"] = "Local XML signing";
$lang["sign_xml_locally"] = "Sign XML locally";
$lang["local_signature_correct"] = "Local signature is correct.";
$lang["signed_xml_not_stamped"] = "This XML is locally signed but not stamped, has no UUID, and has no definitive fiscal validity yet.";
$lang["signed_xml_already_exists"] = "An identical signed XML already exists for this certificate.";
$lang["view_signed_xml"] = "View signed XML";
$lang["download_signed_xml"] = "Download signed XML";
$lang["signed_xml_verification_valid"] = "The signed XML passed independent verification.";
$lang["signed_xml_verification_failed"] = "The signed XML failed independent verification.";
$lang["verify_signed_xml"] = "Verify signed XML";
$lang["fiscal_pdf_view"] = "View PAC printed representation";
$lang["fiscal_pdf_download"] = "Download PAC printed representation";
$lang["pac_pdf_pending"] = "CFDI stamped; PAC printed representation pending.";
$lang["pac_pdf_error"] = "CFDI stamped; the received Base64 PDF was invalid.";
$lang["pdf_template"] = "PDF template";
$lang["main_template"] = "Main";
$lang["correct"] = "Correct";
$lang["pac_configuration"] = "PAC provider configuration";
...
$lang["api_key_replace_help"] = "Leave blank to keep the current key. The complete key is never displayed again.";
$lang["connection_timeout"] = "Connection timeout (seconds)";
$lang["request_timeout"] = "Request timeout (seconds)";
$lang["pac_connectivity_only_notice"] = "Local configuration is valid. No stamp was consumed.";
$lang["stamp_cfdi"] = "Stamp CFDI";
$lang["stamp_test_cfdi"] = "Stamp test CFDI";
$lang["pac_operation"] = "PAC operation";
$lang["signed_xml_hash"] = "Signed XML hash";
$lang["private_key_sent"] = "Send keyPEM";
$lang["certificate_sent"] = "Send cerPEM";
$lang["certificate_password_sent"] = "Send password";
$lang["configure_csd_password"] = "Configure CSD password";
$lang["update_csd_password"] = "Update CSD password";
$lang["csd_operational_status"] = "Operational status";
$lang["csd_password_configured"] = "The CSD password was protected and validated.";
$lang["csd_password_configuration_failed"] = "The CSD password could not be configured.";
$lang["csd_certificate_not_ready"] = "The fiscal certificate is not available.";
$lang["csd_password_vault_notice"] = "The password is validated and encrypted on the server. It cannot be viewed or recovered.";
$lang["fiscal_invoice_center"] = "Fiscal invoices";
$lang["cancel_fiscal_invoice"] = "Cancel fiscal invoice";
$lang["fiscal_visible_status_draft"] = "Draft";
$lang["fiscal_visible_status_processing"] = "Processing";
$lang["fiscal_visible_status_signed"] = "Signed";
$lang["fiscal_visible_status_stamped"] = "Stamped";
$lang["fiscal_visible_status_stamped_pdf_pending"] = "Stamped, PDF pending";
$lang["fiscal_visible_status_stamped_pdf_error"] = "Stamped, PDF error";
$lang["fiscal_visible_status_correctable_error"] = "Correctable error";
$lang["fiscal_visible_status_unknown"] = "Unknown status";
$lang["fiscal_visible_status_cancellation_pending"] = "Cancellation pending";
$lang["fiscal_visible_status_cancelled"] = "Cancelled";
$lang["fiscal_visible_status_cancellation_rejected"] = "Cancellation rejected";
$lang["fiscal_visible_status_cancelled_internal"] = "Internally cancelled";
$lang["fiscal_visible_status_superseded"] = "Superseded";
$lang["fiscal_invoices_view"] = "View fiscal invoice center";
$lang["fiscal_invoices_download_xml"] = "Download fiscal invoice XML";
$lang["fiscal_invoices_download_pdf"] = "Download fiscal invoice PDF";
$lang["fiscal_invoices_cancel"] = "Cancel fiscal invoices";
$lang["fiscal_invoices_view_cancellation"] = "View fiscal cancellations";
$lang["fiscal_invoices_reconcile_cancellation"] = "Reconcile fiscal cancellations";
$lang["csd_automatic_signing_notice"] = "Signing will automatically use the protected CSD password.";
$lang["csrf_session_expired"] = "The security session expired. Reload the form and try again.";
$lang["generate_invoice"] = "Generate invoice";
$lang["save_draft"] = "Save draft";
$lang["fake_pac"] = "Fake PAC";
$lang["advanced_fiscal_tools"] = "Advanced fiscal tools";
$lang["processing_invoice"] = "Processing invoice…";
$lang["fiscal_generation_environment"] = "Generation environment";
$lang["confirm_new_fiscal_version"] = "Create a new version after correcting fiscal data.";
$lang["fiscal_result"] = "Fiscal result";
$lang["confirm_sandbox_stamp"] = "Confirm one stamping request to the sandbox. This action cannot be undone.";
$lang["stamping"] = "Stamping";
$lang["stamped"] = "Stamped";
$lang["stamp_result"] = "Stamp result";
$lang["stamp_date"] = "Stamp date";
$lang["technical_detail"] = "Technical detail";
$lang["sandbox_stamp_notice"] = "This CFDI will be sent to the TimbradorXpress sandbox environment.";
$lang["production_stamp_notice"] = "This CFDI will be sent to production and may acquire fiscal validity.";
$lang["pac_configuration_required"] = "Configure an active sandbox PAC provider before stamping.";
$lang["cfdi_stamped_successfully"] = "The CFDI was stamped and stored successfully.";
$lang["fiscal_pac_view"] = "View PAC configuration";
$lang["fiscal_pac_manage"] = "Manage PAC configuration";
$lang["fiscal_stamp_sandbox"] = "Stamp CFDI in sandbox";
$lang["fiscal_stamp_production"] = "Stamp CFDI in production";
$lang["fiscal_stamp_status"] = "Query CFDI status";
$lang["fiscal_stamp_reconcile"] = "Reconcile stamping";
$lang["fiscal_stamped_xml_view"] = "View stamped XML";
$lang["fiscal_stamped_xml_download"] = "Download stamped XML";
$lang["fiscal_stamp_error_details"] = "View PAC technical error details";
$lang["recommended_action"] = "Recommended action";
$lang["fiscal_access_denied"] = "You do not have permission to view this fiscal document.";
$lang["stamped_xml"] = "Stamped XML";
$lang["stamping_provider"] = "Stamping provider";
$lang["test_environment"] = "Test environment";
$lang["technical_status"] = "Technical status";
$lang["pac_configured"] = "PAC configured";
$lang["pac_not_configured"] = "PAC not configured";
$lang["pac_env_only_notice"] = "Provider, environment, and credentials are managed exclusively through private server configuration.";
$lang["view_stamped_xml"] = "View stamped XML";
$lang["download_stamped_xml"] = "Download stamped XML";
$lang["view_pdf"] = "View PDF";
$lang["download_pdf"] = "Download PDF";
$lang["fiscal_stamped_pdf_view"] = "View printed representation";
$lang["fiscal_stamped_pdf_download"] = "Download printed representation";
$lang["fiscal_pac_status_view"] = "View PAC technical status";
$lang["fiscal_pdf_generation_failed"] = "The CFDI was stamped, but its printed representation requires controlled regeneration.";
$lang["pac_rejected_cfdi"] = "The PAC rejected the CFDI";
$lang["recommended_action"] = "Recommended action";
$lang["consult_sat_status"] = "Query SAT status";
$lang["transport_error"] = "Transport error";
$lang["invalid_response"] = "Invalid response";
$lang["previously_stamped"] = "Previously stamped document";
$lang["reconciliation"] = "Reconciliation";
$lang["unknown_status"] = "Unknown status";
$lang["fiscal_cancellation_ack"] = "Cancellation acknowledgement";

$lang["fiscal_pdf_generate"] = "Generate or recover PDF";
$lang["fiscal_pdf_templates_view"] = "View fiscal PDF templates";
$lang["fiscal_pdf_templates_manage"] = "Manage fiscal PDF templates";
$lang["fiscal_pdf_templates"] = "PDF templates";
$lang["pdf_template_code"] = "Template code";
$lang["pdf_template_saved"] = "The PDF template was saved successfully.";
$lang["pdf_template_invalid"] = "The PDF template configuration is invalid.";
$lang["generate_or_recover_pdf"] = "Generate or recover PDF";
$lang["pdf_generated"] = "The printed representation was generated successfully.";
$lang["fiscal_visible_status_stamped_pdf_processing"] = "PDF processing";
$lang["fiscal_visible_status_stamped_pdf_unknown"] = "PDF reconciliation required";
$lang["fiscal_billing"] = "Billing";
$lang["fiscal_invoices"] = "Invoices";
$lang["fiscal_invoice_view"] = "View fiscal invoice detail";
$lang["fiscal_xml_download"] = "Download fiscal XML";
$lang["fiscal_cancel_request"] = "Request fiscal cancellation";
$lang["fiscal_cancellation_receipt_view"] = "View cancellation receipt";
$lang["fiscal_status_query"] = "Query fiscal status";
return $lang;
