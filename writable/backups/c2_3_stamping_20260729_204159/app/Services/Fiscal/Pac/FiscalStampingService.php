...
final class FiscalStampingService
{
    ...
    public function stamp(int $documentId, int $userId, bool $authorized): FiscalStampingResult
    {
        ...
        [$document, $artifact, $attempt, $xml, $existing] =
            $this->prepare($documentId, $userId, $provider, $environment);
        ...
        // This update must succeed before the adapter is invoked.
        ...
        try {
            ...
            $validated = (new StampedXmlValidator())->validate($stampedXml, $xml);
