...
final class FiscalIntegrationStamp extends BaseCommand
{
    ...
    public function run(array $params):void
    {
        ...
        try{
            ...
            if(!$draft||$draft->environment!=='development'||$draft->data_origin!=='integration_manual_candidate')
                throw new RuntimeException('El borrador no es el candidato manual de integration.');
